(function() {
    ...
    app.AppView = Backbone.View.extend({
        ...
        render: function() {
            ...
            this.$stats.html(this.statsTemplate({completed: completed, active: active}));
        ...
        getItemAttrs: function() {
            ...
            return {title: this.$newInput.val().trim(), completed: false, order: this.collection.nextId()};
        },
